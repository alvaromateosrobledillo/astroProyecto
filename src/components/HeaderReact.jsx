...
import { HomeIcon, BriefcaseIcon, PhoneIcon, CogIcon } from '@heroicons/react/24/outline';
import ThemeToggle from "./ThemeToggle.jsx";

const navItems = [
  { title: "INICIO", url: "/", icon: <HomeIcon className="w-6 h-6 mr-2" /> },
  { title: "SERVICIOS", url: "/#servicios", icon: <CogIcon className="w-6 h-6 mr-2" /> },
  { title: "PROYECTOS", url: "/#proyectos", icon: <BriefcaseIcon className="w-6 h-6 mr-2" /> },
  { title: "CONTACTO", url: "/#contacto", icon: <PhoneIcon className="w-6 h-6 mr-2" /> },
];
